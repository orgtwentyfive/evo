...
async function main() {
    ...
    for (const category of categories) {
        ...
        for (const service of services.publicServices) {
            ...
            result.push({ code, title, description, eService, categoryName, categoryDescription, categoryId, toIndexData })
            console.log(i++)
        }
    }
    ...
    for (const event of events) {
        ...
        result.push({ type: 'event', code: event.code, title, description, toIndexData: textSteps })
        console.log(i++)
    }
